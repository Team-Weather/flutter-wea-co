...
import 'package:weaco/domain/common/file/use_case/get_home_background_image_list_use_case.dart';
...
void main() {
  group('GetHomeImageUseCase 클래스', () {
    ...
    final GetHomeBackgroundImageListUseCase getHomeBackgroundImageListUseCase =
        GetHomeBackgroundImageListUseCase(fileRepository: mockFileRepository);
